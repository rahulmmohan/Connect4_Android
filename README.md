...
* Menu - Used to select the game mode - User can play against a Computer or a friend, can choose the color disc,first turn and        the dificulty when playing with computer.
* Game play - game play goes here.
